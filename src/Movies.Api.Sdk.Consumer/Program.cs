...
services
    ...
    {
        AuthorizationHeaderValueGetter = async (request, ct) => await s.GetRequiredService<AuthTokenProvider>().GetTokenAsync()
    })
...
var movie = await moviesApi.GetMovieAsync("nick-the-greek-2-2023");
